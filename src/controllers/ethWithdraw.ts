...
const HOT_WALLET =
    NODE_ENV === "production"
        ? "0x955250Fd0F7f4F6eE3570535f9B7AD3B8141F148"
        : "0xE21095c0be9c57f2ebb4FeE72c418B5CF447e8ae";
let provider;
...
const coiinAddress =
    NODE_ENV === "production"
        ? "0x87ff4a65200337b88ae5c43650e2b7d5a8f17d10"
        : "0x0bbd0b3bca94b037b73ff3e02db3154aa558113f";
...
export const performCoiinTransfer = async (to: string, value: BigNumber, currency: string = "coiin") => {
    ...
    if (currency !== "coiin" && currency !== "eth")
        tokenContractAddress = (await CryptoCurrency.findOneOrFail({ where: { type: currency } })).contractAddress;
    ...
    if (bigBalance.isLessThan(value)) {
        throw new Error(
            `A problem occured sending ${currency} to your ethereum wallet. Please try again in a few minutes. If this problem persists, please contact support.`
        );
    }
