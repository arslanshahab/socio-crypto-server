...
export class NftTable1662720274289 implements MigrationInterface {
    name = 'NftTable1662720274289'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "nft" ("nftId" character varying NOT NULL, "type" character varying NOT NULL, "name" character varying NOT NULL, "network" character varying NOT NULL, "transactions" jsonb, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "userId" uuid, CONSTRAINT "UQ_1156642d40093c2cf27efc405a5" UNIQUE ("nftId"), CONSTRAINT "UQ_fbf824aa02944ec173092a028f1" UNIQUE ("transactions"), CONSTRAINT "PK_1156642d40093c2cf27efc405a5" PRIMARY KEY ("nftId"))`);
