...
export class Profile1596142871003 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query(`INSERT INTO "profile" ("userId", "username", "recoveryCode", "deviceToken", "email") SELECT "user"."id" AS "userId", "user"."username" AS "username", "user"."recoveryCode" AS "recoveryCode", "user"."deviceToken" AS "deviceToken", "user"."email" AS "email" FROM "user"`)
