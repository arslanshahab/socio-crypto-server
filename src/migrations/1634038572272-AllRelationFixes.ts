...
export class AllRelationFixes1634038572272 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "deposit_address" RENAME COLUMN "adminId" TO "orgId"`);
        ...
        await queryRunner.query(`ALTER TABLE "deposit_address" ALTER COLUMN "orgId" DROP NOT NULL`);
        ...
        await queryRunner.query(`ALTER TABLE "deposit_address" ADD CONSTRAINT "FK_fd5797efa6c7fccf49f6557d7c8" FOREIGN KEY ("orgId") REFERENCES "org"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "deposit_address" DROP CONSTRAINT "FK_fd5797efa6c7fccf49f6557d7c8"`);
        ...
        await queryRunner.query(`ALTER TABLE "deposit_address" ALTER COLUMN "orgId" SET NOT NULL`);
        ...
        await queryRunner.query(`ALTER TABLE "deposit_address" RENAME COLUMN "orgId" TO "adminId"`);
    }
