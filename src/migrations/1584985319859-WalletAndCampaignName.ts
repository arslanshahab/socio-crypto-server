...
export class WalletAndCampaignName1584985319859 implements MigrationInterface {
    public async up(queryRunner: QueryRunner): Promise<any> {
        await queryRunner.query(
            `CREATE TABLE "wallet" ("id" uuid NOT NULL DEFAULT gen_random_uuid(), "balance" integer NOT NULL DEFAULT 0, "userId" character varying, CONSTRAINT "REL_35472b1fe48b6330cd34970956" UNIQUE ("userId"), CONSTRAINT "PK_bec464dd8d54c39c54fd32e2334" PRIMARY KEY ("id"))`
        );
        ...
        await queryRunner.query(
            `ALTER TABLE "participant" ADD CONSTRAINT "PK_084d2d56c49133d78f4de0054c3" PRIMARY KEY ("id", "userId")`
        );
        ...
        await queryRunner.query(
            `INSERT INTO "wallet" ("userId", "balance") SELECT "user"."id" as "userId", 0 as "balance" FROM "user"`
        );
    }
