...
export class CustodialAddress1643035587533 implements MigrationInterface {
    name = "CustodialAddress1643035587533";

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(
            `CREATE TABLE "custodial_address" ("id" uuid NOT NULL DEFAULT gen_random_uuid(), "chain" character varying NOT NULL, "available" boolean NOT NULL DEFAULT true, "address" character varying NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_66a3eeadf9b81e7784b0240b7bb" PRIMARY KEY ("id"))`
        );
