...
export class RaffleCampaign1607969255466 implements MigrationInterface {
    public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query(
            `ALTER TABLE "raffle_prize" ADD CONSTRAINT "FK_29f131f37d9cbb4814b2b6d3069" FOREIGN KEY ("campaignId") REFERENCES "campaign"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`
        );
        await queryRunner.query(
            `ALTER TABLE "transfer" ADD CONSTRAINT "FK_f6c593d6013276bc80450c7638e" FOREIGN KEY ("rafflePrizeId") REFERENCES "raffle_prize"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`
        );
