...
export class TransferTable1592519461655 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
        await queryRunner.query(`CREATE TABLE "transfer" ("id" uuid NOT NULL DEFAULT gen_random_uuid(), "amount" double precision NOT NULL, "action" character varying NOT NULL, "withdrawStatus" character varying, "campaignId" character varying, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "walletId" uuid, CONSTRAINT "PK_fd9ddbdd49a17afcbe014401295" PRIMARY KEY ("id"))`);
