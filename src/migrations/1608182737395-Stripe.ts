...
export class Stripe1608182737395 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "escrow" ("id" uuid NOT NULL DEFAULT gen_random_uuid(), "amount" character varying NOT NULL, "fundingWalletId" uuid, "campaignId" uuid, CONSTRAINT "REL_9a7c2a319665a11a340b523f59" UNIQUE ("campaignId"), CONSTRAINT "PK_4aafc323d34fd7979460661ab4a" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "escrow" ADD CONSTRAINT "FK_9a7c2a319665a11a340b523f591" FOREIGN KEY ("campaignId") REFERENCES "campaign"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
