...
export class CampaignRelationToTransfer1592588010821 implements MigrationInterface {
    public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query(
            `ALTER TABLE "transfer" ADD CONSTRAINT "FK_bbe21a18f940dab59ffd61671ef" FOREIGN KEY ("campaignId") REFERENCES "campaign"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`
        );
    }
