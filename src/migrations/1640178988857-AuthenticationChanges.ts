...
export class AuthenticationChanges1640178988857 implements MigrationInterface {
    name = "AuthenticationChanges1640178988857";
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "verification" ADD "code" character varying NOT NULL`);
