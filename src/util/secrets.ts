...
export class Secrets {
  ...
  public static async initialize() {
    ...
    Secrets.factorProviderPrivateKey = process.env.FACTOR_PROVIDER_PRIVATE_KEY || (await readFilePromise('/var/secrets/factor-credentials/privateKey', 'utf8'));
    Secrets.factorProviderPublicKey = process.env.FACTOR_PROVIDER_PUBLIC_KEY || (await readFilePromise('/var/secrets/factor-credentials/publicKey', 'utf8'));
