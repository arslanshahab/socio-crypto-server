...
import { BN, generateRandomNumber } from "../src/util";
import { getBeginDate, getEndDate } from "../test/integration/specHelpers";
...
export const ageRanges = ["0-17", "18-25", "26-40", "41-55", "55+"];
